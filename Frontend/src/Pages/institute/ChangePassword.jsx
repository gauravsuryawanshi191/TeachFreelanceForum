    ...
    <div className="container">
         <div className="row">
             ...
             <form onSubmit={handleLogin}>                     
                     ...
                     <input className="input form-control" type="email" required value={email} onChange={event => setEmail(event.target.value)} />
                     ...
                     <div className="d-grid gap-2">
                      <button type="submit"   className="btn btn-success" disabled={!password}>Change Password</button>                 
                     </div> 
