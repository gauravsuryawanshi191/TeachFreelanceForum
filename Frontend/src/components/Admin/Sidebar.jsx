          ...
          <div className='col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-light'>
            <div className='d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100'>
              ...
              <ul className='nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start' id='menu'>                
                ...
                <li>
                  <a href='/Admin/dashboard/get-freelancer' className='nav-link px-0 align-middle pb-4' >
                    <i className='fa-solid fa-table'></i>
                    <span className='ms-2 d-none d-sm-inline'>View Freelancers</span></a>
                </li>
                <li>
                  <a href='/Admin/dashboard/institute-verify' className='nav-link px-0 align-middle pb-4' >
                    <i className='fa-solid fa-table'></i>
                    <span className='ms-2 d-none d-sm-inline'>Institute Verification</span></a>
                </li>
                <li>
                  <a href='/Admin/dashboard/institute-delete' className='nav-link px-0 align-middle pb-4' >
                    <i className='fa-solid fa-table'></i>
                    <span className='ms-2 d-none d-sm-inline'>Delete Institute Account</span></a>
                </li>
